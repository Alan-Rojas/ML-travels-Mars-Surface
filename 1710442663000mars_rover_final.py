...
start_position = (2850, 6400)
goal_position = (3150, 6800)
...
# DFS
result_dfs = depth_first(mars_problem,graph_search=True)
...
if result_dfs:
    ...
    price_dfs = result_dfs.cost * 10.0174
    path_dfs = [point for point in path_dfs if None not in point]
    dfs_points = convert_path_to_points(path_dfs)
    print("DFS Points:", dfs_points)
    print("Cost:", price_dfs)
